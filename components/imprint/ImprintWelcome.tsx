  ...
  return (
    <div className={cn('relative h-full w-full rounded-full bg-transparent')}>
      <div
        ...
        className='group/card relative flex h-[400px] w-full overflow-hidden rounded-3xl bg-transparent'
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
          ...
          <div className='relative flex h-full w-full rounded-full'>
            <div className='grid w-full grid-cols-6'>
              <div className='col-span-4 mr-96'>
                <div className='cursor-default pl-3 pt-4'>
                  <h1>Imprint</h1>
                  <h2> Melvin Rinkleff </h2>
                  <a
                    href='https://maps.app.goo.gl/bt5Zafb8VN1BnuF29'
                  ...
                  <div className='flex flex-col gap-1'>
                    <a
                      className='flex cursor-default flex-row gap-2 hover:text-lime-500'
                      href='mailto:melvin@rinkleff.dev'
                      target='_blank'
                      rel='noopener noreferrer'
                    >
                      {' '}
                      <LucideAtSign size={24} />
                      <p>melvin@rinkleff.dev</p>
                    </a>
                    <a
                      className='flex cursor-default flex-row gap-2 hover:text-blue-500'
                    ...
                    <a
                      className='flex cursor-default flex-row gap-2 hover:text-violet-500'
                    ...
                    <a
                      className='flex cursor-default flex-row gap-2 hover:text-red-500'
              ...
              >
                <ul className='mt-4'>
                  {welcomeInfo.map((info) => (
                    <li key={info.key}>
                      <span
                        className={`text-${currentColor}-500 mr-1 font-bold`}
                      >
                        {info.key}:
                      </span>
                      {info.value}
